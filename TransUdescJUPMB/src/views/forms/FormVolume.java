...
public class FormVolume extends BaseForm {
    ...
    public JTextField getTextFieldPesoBruto() {
        return textFieldPesoBruto;
    }

    public void setTextFieldPesoBruto(JTextField textFieldPesoBruto) {
        this.textFieldPesoBruto = textFieldPesoBruto;
    }

    public JTextField getTextFieldPesoLiquido() {
        return textFieldPesoLiquido;
    }

    public void setTextFieldPesoLiquido(JTextField textFieldPesoLiquido) {
        this.textFieldPesoLiquido = textFieldPesoLiquido;
    }

    public JTextField getTextFieldCubagem() {
        return textFieldCubagem;
    }
